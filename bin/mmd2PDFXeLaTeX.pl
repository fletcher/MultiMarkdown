#!/usr/bin/env perl
#
# $Id: mmd2PDFXeLaTeX.pl 534 2009-06-19 20:52:55Z fletcher $
#
...
text into a PDF via XeLaTeX.

=head1 SYNOPSIS

mmd2PDFXeLaTeX.pl [file ...]


=head1 DESCRIPTION

This script is designed as a "front-end" for MultiMarkdown. It can convert a
series of text files into XeLaTeX, and then into PDF.
